...
class ApplicationMain {
	...
	public static function main() {
		...
		var loader:Loader = new Loader();
		loaders.set("assets/gfx/bg.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader();
		loaders.set("assets/gfx/crown.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader();
		loaders.set("assets/gfx/gover_bg.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader();
		loaders.set("assets/gfx/Green_ninja.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader();
		loaders.set("assets/gfx/helmet.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader();
		loaders.set("assets/gfx/marblessheet_16x16.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader();
		loaders.set("assets/gfx/menu_bg.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/gfx/start_floor.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader();
		loaders.set("assets/gfx/wall.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader();
		loaders.set("assets/gfx/wall_brick.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader();
		loaders.set("assets/gfx/wall_right.png", loader);
		total ++;
