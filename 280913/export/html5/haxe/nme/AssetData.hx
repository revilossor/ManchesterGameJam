...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			path.set ("assets/gfx/start_floor.png", "assets/gfx/start_floor.png");
			...
			path.set ("assets/gfx/wall_brick.png", "assets/gfx/wall_brick.png");
			type.set ("assets/gfx/wall_brick.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/gfx/wall_right.png", "assets/gfx/wall_right.png");
